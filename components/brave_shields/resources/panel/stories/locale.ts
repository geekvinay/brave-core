...
provideStrings({
  ...
  braveShieldsUp: 'Up',
  braveShieldsBroken: 'If this site seems broken, try Shields down. Note: this may reduce Brave privacy protections.',
  braveShieldsBlockedNote: 'Trackers, ads, and more blocked',
  braveShieldsLearnMore: 'Learn more',
  braveShieldsAdvancedCtrls: 'Advanced Controls',
  braveShieldSettingsDescription: 'These settings affect web compatibility on this site.',
  braveShieldsGlobalSettingsTitle: 'Global Shield settings',
  braveShieldsChangeDefaults: 'Change global Shield defaults',
  braveShieldsCustomizeAdblockLists: 'Customize Adblock Lists',
  braveShieldsConnectionsUpgraded: 'Connections upgraded to HTTPS',
  braveShieldsHTTPSEnable: 'Enable HTTPS',
  braveShieldsScriptsBlocked: 'Scripts Blocked',
  ...
  braveShieldsTrackersAndAdsAllowAll: 'Allow all trackers and ads',
